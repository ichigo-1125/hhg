...
impl<T> Deque<T>
{
    ...
    //  先頭の要素の参照を取得する。
    //--------------------------------------------------------------------------
    #[doc = include_str!("../../doc/collections/deque/front.md")]
    #[inline]
    ...
    //  先頭の要素の可変参照を取得する。
    //--------------------------------------------------------------------------
    #[doc = include_str!("../../doc/collections/deque/front_mut.md")]
    #[inline]
    ...
    //  末尾の要素の参照を取得する。
    //--------------------------------------------------------------------------
    #[doc = include_str!("../../doc/collections/deque/back.md")]
    #[inline]
    ...
    //  末尾の要素の可変参照を取得する。
    //--------------------------------------------------------------------------
    #[doc = include_str!("../../doc/collections/deque/back_mut.md")]
    #[inline]
...
impl<T> Deque<T>
{
    ...
    //--------------------------------------------------------------------------
    #[doc = include_str!("../../doc/collections/deque/make_contiguous.md")]
    #[inline]
...
impl<T> From<Vector<T>> for Deque<T>
{
    //--------------------------------------------------------------------------
    //  from
    //--------------------------------------------------------------------------
    ...
    {
        Deque { deq: VecDeque::from(other.v) }
    }
}

impl<T> From<Deque<T>> for Vector<T>
{
    //--------------------------------------------------------------------------
    //  from
    //--------------------------------------------------------------------------
    #[inline]
    fn from( other: Deque<T> ) -> Self
    {
        Vector { v: Vec::from(other.deq) }
    }
}
